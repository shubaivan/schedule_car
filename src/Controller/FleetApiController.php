 ...
 *
 * Ведуть директори — тут роздають машини й закріплюють за ними людей, тож поріг
 * вищий, ніж у заявках: менеджер із постачання сюди не заходить. Адміністратор
 * теж проходить: за ієрархією ролей у нього є й роль директора.
 */
#[IsGranted('ROLE_SUPPLY_DIRECTOR')]
#[Route('/api/fleet')]
